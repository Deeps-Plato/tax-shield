...
FIELDS_1099_NEC = {
    ...
    "nonemployee_compensation": {"label": "1 - Nonemployee compensation", "type": "currency", "box": 1},
...
FIELDS_1099_MISC = {
    ...
    "medical_payments": {"label": "6 - Medical and health care payments", "type": "currency", "box": 6},
    "crop_insurance": {"label": "9 - Crop insurance proceeds", "type": "currency", "box": 9},
    "gross_proceeds_attorney": {"label": "10 - Gross proceeds paid to an attorney", "type": "currency", "box": 10},
    "section_409a_deferrals": {"label": "12 - Section 409A deferrals", "type": "currency", "box": 12},
    "excess_golden_parachute": {"label": "13 - Excess golden parachute payments", "type": "currency", "box": 13},
    "nonqualified_deferred": {"label": "14 - Nonqualified deferred compensation", "type": "currency", "box": 14},
}
