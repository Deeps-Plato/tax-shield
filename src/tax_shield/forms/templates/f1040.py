...
FIELDS = {
    "filing_status": {"label": "Filing Status", "type": "select", "options": [
    ...
    "capital_gain_loss": {"label": "7 - Capital gain or loss (Schedule D)", "type": "currency", "line": 7},
    ...
    # Adjustments
    "adjustments": {"label": "10 - Adjustments to income (Schedule 1)", "type": "currency", "line": 10},
    "agi": {"label": "11 - Adjusted gross income", "type": "currency", "line": 11, "computed": True},

    # Deductions
    "standard_deduction": {"label": "12 - Standard deduction or itemized (Sch A)", "type": "currency", "line": 12},
    "qbi_deduction": {"label": "13 - Qualified business income deduction", "type": "currency", "line": 13},
    "total_deductions": {"label": "14 - Total deductions", "type": "currency", "line": 14, "computed": True},
    "taxable_income": {"label": "15 - Taxable income", "type": "currency", "line": 15, "computed": True},
    ...
    # Payments
    "federal_withheld": {"label": "25 - Federal income tax withheld", "type": "currency", "line": 25},
    "estimated_payments": {"label": "26 - Estimated tax payments", "type": "currency", "line": 26},
    "total_payments": {"label": "33 - Total payments", "type": "currency", "line": 33, "computed": True},

    # Refund / Owed
    "overpaid": {"label": "34 - Overpaid", "type": "currency", "line": 34, "computed": True},
    "amount_owed": {"label": "37 - Amount you owe", "type": "currency", "line": 37, "computed": True},
}
