...
FIELDS = {
    ...
    "returns_allowances": {"label": "1b - Returns and allowances", "type": "currency", "line": "1b"},
    ...
    "total_income": {"label": "6 - Total income (loss)", "type": "currency", "line": 6, "computed": True},

    # Deductions
    "compensation_officers": {"label": "7 - Compensation of officers", "type": "currency", "line": 7},
    ...
    "pension_plans": {"label": "17 - Pension, profit-sharing plans", "type": "currency", "line": 17},
    ...
    "total_deductions": {"label": "20 - Total deductions", "type": "currency", "line": 20, "computed": True},

    "ordinary_business_income": {"label": "21 - Ordinary business income (loss)", "type": "currency", "line": 21, "computed": True},
}
