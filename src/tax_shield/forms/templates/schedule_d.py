...
FIELDS = {
    ...
    "st_carryover": {"label": "6 - Short-term capital loss carryover", "type": "currency", "line": 6},
    "net_st_gain_loss": {"label": "7 - Net short-term capital gain or (loss)", "type": "currency", "line": 7, "computed": True},
    ...
    "lt_distributions": {"label": "11 - Capital gain distributions", "type": "currency", "line": 11},
    "lt_carryover": {"label": "14 - Long-term capital loss carryover", "type": "currency", "line": 14},
    "net_lt_gain_loss": {"label": "15 - Net long-term capital gain or (loss)", "type": "currency", "line": 15, "computed": True},
    ...
    "total_gain_loss": {"label": "21 - Total capital gain or (loss)", "type": "currency", "line": 21, "computed": True},
}
