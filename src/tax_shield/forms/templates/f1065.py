...
FIELDS = {
    ...
    "total_income": {"label": "8 - Total income (loss)", "type": "currency", "line": 8, "computed": True},

    # Deductions
    "salaries_wages": {"label": "9 - Salaries and wages", "type": "currency", "line": 9},
    "guaranteed_payments": {"label": "10 - Guaranteed payments to partners", "type": "currency", "line": 10},
    ...
    "total_deductions": {"label": "21 - Total deductions", "type": "currency", "line": 21, "computed": True},

    "ordinary_business_income": {"label": "22 - Ordinary business income (loss)", "type": "currency", "line": 22, "computed": True},
}
