...
FIELDS = {
    ...
    "accounting_method": {"label": "F - Accounting method", "type": "select", "options": ["Cash", "Accrual", "Other"]},
    ...
    "gross_income_total": {"label": "7 - Gross income total", "type": "currency", "line": 7, "computed": True},
    ...
    "legal_professional": {"label": "17 - Legal and professional services", "type": "currency", "line": 17},
    "office_expense": {"label": "18 - Office expense", "type": "currency", "line": 18},
    "pension_profit_sharing": {"label": "19 - Pension and profit-sharing plans", "type": "currency", "line": 19},
    "rent_vehicles": {"label": "20a - Rent — vehicles, machinery, equipment", "type": "currency", "line": "20a"},
    "rent_property": {"label": "20b - Rent — other business property", "type": "currency", "line": "20b"},
    ...
    "total_expenses": {"label": "28 - Total expenses", "type": "currency", "line": 28, "computed": True},

    # Net
    "net_profit_loss": {"label": "31 - Net profit or (loss)", "type": "currency", "line": 31, "computed": True},
}
