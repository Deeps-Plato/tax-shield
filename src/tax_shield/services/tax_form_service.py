...
async def compute_form_data(db: AsyncSession, user: User, form_type: str, tax_year: int) -> dict:
...
def _schedule_c_data(user: User, items: list, transactions: list, total_expenses: float) -> dict:
...
def _schedule_a_data(user: User, items: list, transactions: list, total_deductions: float) -> dict:
    return {
